...
define(function(require) {
    ...
    var _ = require('underscore'),
        ...
        baseHeaderCellTemplate = require('text!course-list/list/templates/base-header-cell.underscore'),

        BaseHeaderCell,
        tooltips;

    tooltips = {
        // username: gettext('The name and username of this course. Click to sort by username.'),
    };
    ...
    BaseHeaderCell = Backgrid.HeaderCell.extend({
        ...
        initialize: function() {
            ...
            this.$el.tooltip({container: '.course-list-table'});
        },
