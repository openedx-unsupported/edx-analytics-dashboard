define((require) => {
  ...
  describe('LearnersRouter', () => {
    ...
    describe('showLearnerRosterPage', () => {
      beforeEach(function () {
      ...
      it('should trigger on an empty URL fragment with a querystring', function () {
        const querystring = 'text_search=some_username';
    ...
    describe('showLearnerDetailPage', () => {
      ...
      it('should trigger on a username and a querystring', function () {
        const querystring = 'order_by=problems_attempted';
        this.router.navigate(`username/?${querystring}`, { trigger: true });
        expect(this.controller.showLearnerDetailPage).toHaveBeenCalledWith('username', querystring, null);
      });
    });
