define((require) => {
  ...
  describe('LearnerModel', () => {
    ...
    it('should parse engagement metrics', () => {
      const learner = new LearnerModel({
        engagements: {
    ...
    it('should treat the username as its id', () => {
      let learner = new LearnerModel({ username: 'daniel', course_id: 'edX/DemoX/Demo_Course' });
      // eslint-disable-next-line no-unused-vars
      const collection = new (Backbone.Collection.extend({ url: '/endpoint/' }))([learner]);
    ...
    it('should use username to determine if data is available', () => {
      const learner = new LearnerModel();
