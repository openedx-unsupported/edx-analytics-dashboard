...
class CourseEnrollmentActivityTests(CourseEnrollmentTests, WebAppTest):
    ...
    def test_enrollment_summary_and_graph(self):
        ...
        self.assertSummaryPointValueEquals('stat', stat_type, unicode(value))
        self.assertSummaryTooltipEquals('data-stat-type={0}'.format(stat_type), 'Change in enrollment during the last 7 days (through 23:59 UTC).')
