...
upgrade: ## update the requirements/*.txt files with the latest packages satisfying requirements/*.in
	...
	grep -e "^django==" -e "^django-soapbox==" requirements/base.txt > requirements/django.txt
	sed '/^[dD]jango==/d;/^django-soapbox==/d' requirements/test.txt > requirements/test.tmp
